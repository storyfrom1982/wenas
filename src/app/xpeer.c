...
int main(int argc, char *argv[])
{
    ...
    xmsger_connect(server->msger, "47.92.77.19", 9256, task);
    // xmsger_connect(server->msger, "120.78.155.213", 9256, task);
    // xmsger_connect(server->msger, "18.138.128.58", 9256, task);
