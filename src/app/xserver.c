...
static void on_message_from_peer(xmsgercb_ptr listener, xchannel_ptr channel, xlinekv_ptr xkv)
{
...
static void api_timeout(xpeer_ctx_ptr pctx)
{
    ...
    xlinekv_ptr msg = xl_find_ptr(&pctx->xlparser, "msg");
